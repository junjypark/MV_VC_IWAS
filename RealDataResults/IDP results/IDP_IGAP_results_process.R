...
for (chr in 1:22) {
  ...
  colnames(chr_D) <- c("# WM tract FA", "# WM tract MO", "# WM tract diffusivity", 
...
table(MRIIDP$Category[which(MRIIDP$`IDP description` %in% unique(unlist(des_S_8[[1]])))])
...
for (i in 1:length(chr_result_sig_8)) {
  if (is.null(MRI_S_region_8)) {
    MRI_S_region_8 <- MRIIDP$Pheno[as.numeric(chr_result_sig_8[[i]]$S[3, ])]
    MRI_S_category_8  <- MRIIDP$Category[as.numeric(chr_result_sig_8[[i]]$S[3, ])]
  } else {
    MRI_S_region_8 <- c(MRI_S_region_8, MRIIDP$Pheno[as.numeric(chr_result_sig_8[[i]]$S[3, ])])
    MRI_S_category_8 <- c(MRI_S_category_8, MRIIDP$Category[as.numeric(chr_result_sig_8[[i]]$S[3, ])])
  }
}
...
table(MRIIDP$Category[which(MRIIDP$`IDP description` %in% unique(unlist(des_D_8[[1]])))])
...
for (i in 1:length(chr_result_8_sig)) {
  if (is.null(MRI_D_region_8)) {
    ...
    MRI_D_category_8 <- MRIIDP$Category[as.numeric(chr_result_8_sig[[i]]$D[3, ])]
  } else {
    MRI_D_region_8 <- c(MRI_D_region_8, MRIIDP$region[as.numeric(chr_result_8_sig[[i]]$D[3, ])])
    MRI_D_category_8 <- c(MRI_D_category_8, MRIIDP$Category[as.numeric(chr_result_8_sig[[i]]$D[3, ])])
  }
}
...
table(MRIIDP$Category[which(MRIIDP$`IDP description` %in% unique(unlist(des_S_19[[1]])))])
...
for (i in 1:length(chr_result_sig_19)) {
  if (is.null(MRI_S_region_19)) {
    ...
    MRI_S_category_19  <- MRIIDP$Category[as.numeric(chr_result_sig_19[[i]]$S[3, ])]
  } else {
    MRI_S_region_19 <- c(MRI_S_region_19, MRIIDP$region[as.numeric(chr_result_sig_19[[i]]$S[3, ])])
    MRI_S_category_19 <- c(MRI_S_category_19, MRIIDP$Category[as.numeric(chr_result_sig_19[[i]]$S[3, ])])
  }
}
...
table(MRIIDP$Category[which(MRIIDP$`IDP description` %in% unique(unlist(des_D_19[[1]])))])
...
for (i in 1:length(chr_result_sig_19)) {
  if (is.null(MRI_D_region_19)) {
    ...
    MRI_D_category_19 <- MRIIDP$Category[as.numeric(chr_result_sig_19[[i]]$D[3, ])]
  } else {
    MRI_D_region_19 <- c(MRI_D_region_19, MRIIDP$region[as.numeric(chr_result_sig_19[[i]]$D[3, ])])
    MRI_D_category_19 <- c(MRI_D_category_19, MRIIDP$Category[as.numeric(chr_result_sig_19[[i]]$D[3, ])])
  }
}
...
##############################################
scat <- as.data.frame(table(MRIIDP$`Category name`[which(MRIIDP$`IDP description` %in% unique(unlist(c(des_S_8[[1]], des_S_19[[1]]))))]))
