...
MRIIDP <- read.csv("/gpfs/fs0/scratch/j/junpark/tianyu47/MV_VC_IWAS/IDP_category/IDP_info_category.csv", header = T)
...
for (chr in 1:22) {
  ...
  saveRDS(chr_IDP_results, file = paste0("/gpfs/fs0/scratch/j/junpark/tianyu47/MV_VC_IWAS/IDP_category/UKB_chr", chr, "_IDP_results.rds"))
}
